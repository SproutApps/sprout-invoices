...
add_action( 'si_theme_customizer', 'si_default_theme_customizer_options' );

// add new options
function si_default_theme_customizer_options( $wp_customize ) {

	if ( 'default' === SI_Templating_API::get_invoice_theme_option() ) {
	...
	if ( 'default' === SI_Templating_API::get_estimate_theme_option() ) {
		///////////////
		// Estimates //
		///////////////
