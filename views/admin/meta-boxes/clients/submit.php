...
<div class="submitbox" id="submitpost">
	...
	<div id="minor-publishing">
		<p>
			...
			<select name="associated_users[]" multiple="mulitple" style="width:100%" class="select2">
				<?php foreach ( $users as $user ): ?>
					<option value="<?php echo $user->ID ?>" <?php selected( in_array( $user->ID, $associated_users ), TRUE ) ?>><?php printf( '%s', $user->display_name, $user->user_email ) ?></option>
				<?php endforeach ?>
			</select>
		</p>
		<p>
